...
Create Schema SportsStore;



CREATE TABLE SportsStore.Users (
...
CREATE TABLE SportsStore.carts (
	id int IDENTITY(1,1) NOT NULL,
...
CREATE TABLE SportsStore.orderinfos (
	id int IDENTITY(1,1) NOT NULL,
...
CREATE TABLE SportsStore.orders (
	id int IDENTITY(1,1) NOT NULL,
...
CREATE TABLE SportsStore.products (
	id int IDENTITY(1,1) NOT NULL,
...
INSERT INTO SportsStore.products (name,price,category,[image],isAvailable) VALUES
...
INSERT INTO SportsStore.products (name,price,category,[image],isAvailable) VALUES
	 ...
	 (N'TennisBag',180,N'Tennis',N'../img/uploads/TennisBag.jpg',1);
